...
export const MORE_MENU = {
  Custom_Language: {name: 'Pick Languages', Icons: Ionicons, icon: 'md-checkbox-outline'},
  Sort_Language: {name: 'Language Rank', Icons: MaterialCommunityIcons, icon: 'sort'},
  Custom_Theme: {name: 'Pick Theme', Icons: Ionicons, icon: 'ios-color-palette'},
  Custom_Key: {name: 'Pick Tag', Icons: Ionicons, icon: 'md-checkbox-outline'},
